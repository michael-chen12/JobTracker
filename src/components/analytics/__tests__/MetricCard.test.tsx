...
describe("MetricCard", () => {
  describe("Basic Rendering", () => {
    it("should render metric label and value", () => {
      render(<MetricCard label="Total Applications" value="45" />);
  ...
  describe("Trend Indicators", () => {
    it("should render positive trend indicator with green badge", () => {
      render(<MetricCard label="Total Applications" value="45" change={25} />);
    ...
    it("should render negative trend indicator with red badge", () => {
      render(<MetricCard label="Response Rate" value="15%" change={-15} />);
    ...
    it("should not render trend indicator when change is 0", () => {
      render(<MetricCard label="Interview Rate" value="10%" change={0} />);
    ...
    it("should not render trend indicator when change is undefined", () => {
      render(<MetricCard label="Interview Rate" value="10%" />);
